...
CREATE TABLE IF NOT EXISTS casbotany.taxa_unmatch (matchID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS casbotany.picturaetaxa_added (newtaxID INTEGER PRIMARY KEY AUTO_INCREMENT,
                                        TimestampCreated VARCHAR(128) NOT NULL ,
                                        TimestampModified VARCHAR(128) NOT NULL ,
                                        batch_MD5 VARCHAR(128),
                                        CatalogNumber VARCHAR(20) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS  casbotany.picturae_batch (batchID INTEGER PRIMARY KEY AUTO_INCREMENT,
